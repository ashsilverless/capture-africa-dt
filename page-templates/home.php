...
<!-- Homepage body content - as demonstrate in Storybook -->
<?php if( have_rows('hero') ): ?>
<?php while( have_rows('hero') ): the_row(); ?>
<?php $heroImage = get_sub_field('hero_background_image');
$heroVideo = get_sub_field('background_video');?>

<div class="component__homepage-hero">
  <div class="component__homepage-hero__hero">
    <div class="component__homepage-hero__hero__container">
      <div
        class="component__banner__hero__background">
        <img
          alt="<?php echo $heroImage['alt']; ?>"
