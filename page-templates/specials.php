...
<div data-expandable-animation-duration="500" data-expandable-container="true" data-expandable-scroll-animation="true"
    data-expandable-one-at-a-time="true" class="component__expandable__container--style-1">
    ...
    <?php
        ...
        ?>
    <div class="component__expandable__item--style-1" data-expandable-item="true" data-expandable-is-expanded="false">
        <div class="component__banner" data-expandable-hero="true">
            <div class="component__banner__hero page__grid">
                <div class="component__banner__hero__container grid__location--wide-content">
                    <div class="component__banner__hero__background">
                        <img <?php $thisImage = $specialImage;?> src="<?php echo $thisImage['url'];?>"
                    ...
                    <div class="page__grid">
                        <div class="component__banner__content grid__location--content">
                            ...
                            <a class="button-three expanding" href="#" data-expandable-cta="true"><span
                                    class="button-three__icon"><svg class="" xmlns="http://www.w3.org/2000/svg"
                                        width="30" height="30">
                                        <path
                                    ...
                                    </svg></span><span class="button-three__wrapper">View Special</span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="page__grid" data-expandable-content="true">
            <div class="grid__location--wide-content component__expandable__content--style-1">
                <div class="page__grid">
                ...
                <div class="page__grid">
                    <div class="grid__location--content">
                        <a class="button-one" href="/contact"><span class="button-one__wrapper">Get In Touch</span></a>
                    </div>
                </div>
            </div>
        </div>
