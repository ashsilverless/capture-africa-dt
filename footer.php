...
<div class="component__footer__legal-row">
  <div class="page__grid component__footer__legal-row__container">
	<div class="silverless-logo">
	  <a
		class="silverless-logo__container"
		href="https://silverless.co.uk"
		title="Silverless"
		><svg
		  version="1.0"
		  id="logo"
		  ...
		  x="0px"
		  y="0px"
		  viewBox="0 0 568.5 122.6"
		  enable-background="new 0 0 568.5 122.6"
		  xml:space="preserve"
		...
		>
		  ...
		  <g id="created">
			...
			></path>
			<path
			  d="M275.7,13.6h-9v28h-6.1v-28H251V8.5h26.1L275.7,13.6z"
			  fill="#372C3B"
			></path>
			<path
